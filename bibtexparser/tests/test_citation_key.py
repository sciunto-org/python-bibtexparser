...
class TestBibtexWriterList(unittest.TestCase):
    ...
    entries_expected = [
        {'alphakey': 'Cés13', 'year': '2013', 'ENTRYTYPE': 'article', 'ID': 'Cesar2013',
         'author': 'Jean César'},
        {'alphakey': 'Ćul99', 'ID': 'test1', 'ENTRYTYPE': 'article', 'year': '1999',
         'author': "{\\'C}ulafi{\\'c}, Dragana"},
        {'alphakey': 'MŽN+09', 'year': '2009', 'ENTRYTYPE': 'article', 'ID': 'test1',
         'author': "Miti{\\'c}-{\\'C}ulafi{\\'c}, Dragana and {\\v{Z}}egura, Bojana and "
                   ...
                   "Filipi{\\v{c}}, Metka"},
        {'alphakey': 'vdBer09', 'year': '2009', 'ENTRYTYPE': 'inproceedings', 'ID': 'test2',
         'author': 'Abraham van der Berk'},
        {'alphakey': 'vdBA02', 'year': '2002', 'ENTRYTYPE': 'inproceedings', 'ID': 'test2',
         'author': 'Abraham van der Berk and Scott Aaronson'},
        {'alphakey': 'Aar09', 'year': '2009', 'ENTRYTYPE': 'inproceedings', 'ID': 'test2',
         'author': 'Scott Aaronson'},
        {'alphakey': 'AFG+12', 'year': '2012', 'ENTRYTYPE': 'article', 'ID': 'test3',
         'author': 'Scott Aaronson and Ewdard Farhi and David Gosset '
                   'and Avinatan Hassidim and Jonathan Kelner and Andrew Lutomirski'},
        {'alphakey': 'LMvdP13', 'year': '2013', 'ENTRYTYPE': 'inproceedings', 'ID': 'LMvdP13',
         'author': 'Laarhoven, Thijs and Mosca, Michele and van de Pol, Joop'},
        {'alphakey': 'vDam13', 'year': '2013', 'ENTRYTYPE': 'article', 'ID': 'vD13',
         'author': 'van Dam, Wim'}]
