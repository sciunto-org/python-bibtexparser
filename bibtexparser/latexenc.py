...
def string_to_latex(string):
    ...
    for char in string:
        if char in escape:
            ...
            new.append(unicode_to_latex.get(char, char))
    return ''.join(new)
...
#        (u"\uFB04", "ffl"),
    ...
    if sys.version_info >= (3, 0):
        unicode_to_latex = dict(to_latex)
        unicode_to_crappy_latex1 = dict(to_crappy_1)
        unicode_to_crappy_latex2 = dict(to_crappy_2)
    else:
        unicode_to_latex = dict((k.decode('unicode-escape'), v) for k, v in to_latex)
        unicode_to_crappy_latex1 = dict((k.decode('unicode-escape'), v) for k, v in to_crappy_1)
        unicode_to_crappy_latex2 = dict((k.decode('unicode-escape'), v) for k, v in to_crappy_2)
